...
class Collabs_Chipz_Lab extends StatefulWidget {
  const Collabs_Chipz_Lab({Key? key}) : super(key: key);

  @override
  State<Collabs_Chipz_Lab> createState() => _Collabs_Chipz_LabState();
}

class _Collabs_Chipz_LabState extends State<Collabs_Chipz_Lab> {
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Collabs_Chipz_Lab()));
                      },
                      child: Container(
